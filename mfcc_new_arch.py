...
def combine_feature():
    ...
    original_feature = load_sound_files(sounds_file_original[:8000]).reshape(8000, 40)
    

    # norm_original_feature = preprocessing.normalize(original_feature, norm='l2')
    # # print((norm_original_feature.shape))
    # original_feature = norm_original_feature
    ...
    fake_feature = load_sound_files(sounds_file_fake[:3000]).reshape(3000, 40)
    
    # norm_fake_feature = preprocessing.normalize(fake_feature, norm='l2')

    # fake_feature = norm_fake_feature
